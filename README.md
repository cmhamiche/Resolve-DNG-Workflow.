...
Adjust temperature and exposure values in Camera Raw. Enable Highlight Recovery if needed. There's a red shift since tint is at 10 by default, put that value at 0 for 5400K.
